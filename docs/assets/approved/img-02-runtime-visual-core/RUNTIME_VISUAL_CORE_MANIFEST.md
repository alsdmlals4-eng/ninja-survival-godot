...
- This package does not add dynamic ward, elemental reaction, Guiin sword aura,
  or Heukyeong ground-shadow texture consumers. Those surfaces have no current
  texture consumer contract.
