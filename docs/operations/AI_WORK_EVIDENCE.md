...
소스1920×1080 전체화면 입력/렌더826356, 초기 PCK렌더843892에서 Space 대시·6000/-4200 이동 후 바닥·대기·20역할 비교·레벨업 마우스 선택 통과. EXE의 -s QA는 실행되지 않아 중지했으며 PCK검증을 EXE직접 포인터검증으로 보고하지 않는다. 최신 실행본/해시는 아래 후속 결과와 Active Context 참조. Human재미·자연속도밸런스·최종그림·1000몹성능·출시 PASS 아님. PR147 Draft유지.
