# 닌자의 신 · Current Canon Checkpoint · DEC-014~022
...
- `docs/planning/2026-08-20-world-run-current-override-dec014-018.md`는 이 checkpoint로 대체된다.

## 미확정 / 임의 변경 금지

- 흑영 표식은 최초 MVP-2 설계의 무기한과 현행 runtime 8초가 불일치한다. 별도 플레이 규칙 결정 전 어느 쪽도 최종 제품 정본으로 임의 승격하지 않는다.
