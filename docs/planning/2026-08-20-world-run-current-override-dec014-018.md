# 닌자의 신 · World / Run Current Override · DEC-014~020

상태: `CURRENT_OVERRIDE / APPROVED_BY_USER_2026-08-20`
기준 branch: `docs/world-core-planning-20260820`

이 문서는 `docs/CURRENT_CONFIRMED_DECISIONS.md` 및 2026-08-20 선행 planning 문서 안에 남아 있는 과거 해석 중 **DEC-014~020과 충돌하는 부분만 보정하는 최신 복구 checkpoint**다. 기존 MVP-4 백팩/Workbench/거래/조합 규칙은 변경하지 않는다.
...
- 유파 Boss 이후 기존 `3 options → choose 1` 보상은 `현재 빌드 강화 / 해방 유파 전승 / 가교·혼합 후보`를 보여주는 기본 authoring을 우선한다.
