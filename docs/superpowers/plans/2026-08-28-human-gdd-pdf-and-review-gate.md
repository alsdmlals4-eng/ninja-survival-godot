...
- [ ] **Step 1: Add the review-gate wording**
...
- [ ] **Step 2: Link the human GDD to its PDF artifact**
...
- [ ] **Step 3: Verify authority consistency**
...
- [ ] **Step 2: Exercise the production command**
...
- [ ] **Step 3: Add regeneration and evidence instructions**
...
- [ ] **Step 1: Check PDF structure and text**
...
- [ ] **Step 3: Correct only validated export defects**
