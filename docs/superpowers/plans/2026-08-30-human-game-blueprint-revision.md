...
- [x] **Step 1: Generate the PDF from the paired Markdown source**
...
- [x] **Step 2: Verify structure and rendering**
...
- [x] **Step 3: Record evidence without overclaiming runtime verification**
...
- [x] **Step 1: Reattack the full scope five times**
