...
| V08 | REQ-MVP4-07 | cadence/elite/stage GUT | existing `tests/unit/test_stage_flow_controller.gd`; `tests/unit/test_stage_elite.gd`; existing `tests/unit/test_wave_spawner.gd`; accelerated integration loop | implementation not started | NOT_RUN |
