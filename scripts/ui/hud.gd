...
@onready var resume_button: Button = $SettingsPanel/Dialog/ResumeButton
@onready var tradition_help_button: Button = $SettingsPanel/Dialog/TraditionHelpButton
@onready var restart_button: Button = $SettingsPanel/Dialog/RestartButton
